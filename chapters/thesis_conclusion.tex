...
This environment will be very challenging due to the slow readout ($\approx \SI{1}{\milli\second\per\metre}$) of \lartpc{}s compared to the beam pulse duration (\SI{10}{\micro\second}).
...
Only keeping fields below \SI{40}{\kilo\volt\per\centi\metre} (as opposed to $\approx \SI{1}{\mega\volt\per\centi\metre}$) everywhere in the detector guarantees a safe operation.
...
More importantly, the mean pile-up-related misidentification of energy depositions from other events was found to be \SIrange{2}{3}{\percent}.
For more than \SI{50}{\percent} of the neutrino events, this error is even smaller than \SI{0.1}{\percent}.

The combination the results from all of this work builds the groundwork for the \AC{}, a novel, fully modular \lartpc{} concept, addressing the most important challenges of future neutrino detectors, in particular the \dune{} near detector.
