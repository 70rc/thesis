...
\section{The High-Multiplicity Environment of the \dune{} ND}
\label{sec:dune-nd_multiplicity}

One of the main goals of \dune{} is to measure the Dirac CP violation phase \dcp provided it has a non-degenerate value.
...
A significant amount of \Pgpz are produced in several resonant and coherent neutrino interactions (see Section~\ref{sec:nu-detection_interactions} and~\cite{dune2}).
