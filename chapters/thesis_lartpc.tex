...
From a noise point of view it is beneficial to put the amplifiers inside the cryostat emerged in \lar\ for two reasons.
...
An additional advantage is that the temperature-dependent Johnson-Nyquist noise of the amplifiers will be reduce at cryogenic temperatures.
