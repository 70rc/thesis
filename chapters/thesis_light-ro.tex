...
The Photon Detection Efficiency (PDE) was measured at room temperature using an \ce{^241 Am} source, previously calibrated with a PMT.
...
More details on the calculations and the calibration of the measurement can be found in~\cite{arclight}.\todo{proper sauce}
