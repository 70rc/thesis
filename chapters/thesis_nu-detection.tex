...
\begin{table}[htb]
	...
	\begin{tabu} to \textwidth {|c|S|S|S|S|}
		...
		\hline
		\Romannum{1} &	60 &											7.5e13 &			0.7 &									1.03 \\
		\hline
		\Romannum{2} &	60 &											1.5e14 &			0.7 &									2.06 \\
		\hline
		\Romannum{1} & 	80 &											7.5e13 &			0.9 &									1.07 \\
		\hline
		\Romannum{2} &	80 &											1.5e14 &			0.9 &									2.14 \\
		\hline
		\Romannum{1} &	120 &											7.5e13 &			1.2 &									1.20 \\
		\hline
		\Romannum{2} &	120 &											1.5e14 &			1.2 &									2.40 \\
		\hline
	\end{tabu}
\end{table}
