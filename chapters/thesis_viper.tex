...
To trigger on scintillation light, one end of the TPC is equipped with a\todo{dimensions} \AL{} module (see Chapter~\ref{chap:light-ro}), while the other end features an ARAPUCA~\cite{arapuca} detector for comparison.
