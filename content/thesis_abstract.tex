...
In particular, their flavour eigenstates do not coincide with their mass eigenstates.
Instead, the flavour eigenstates are a mixture of the mass eigenstates resulting in oscillation for non-zero neutrino masses.
...
An artificially produced neutrino beam is measured with two detectors: one near the source and one far away.
...
A method was developed to operate \lartpc{}s at electric fields an order of magnitude higher than previously achieved.
...
Splitting the detector volume into independent self-contained \glspl{tpc} sharing a common \lar{} bath reduces the required drift voltages to a manageable level.
