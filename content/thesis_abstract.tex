...
\glspl{ac:lartpc} fulfil these requirements excellently and were therefore chosen as far detectors.
...
Splitting the detector volume into small self-contained \gls{ac:tpc} sharing a common \lar{} bath, reduces the required drift voltages to a handleable level.
