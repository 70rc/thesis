...
The Kapton layer was supported by an FR4 frame for mounting on the \gls{tpc}.
...
Alongside the PCB, a new \gls{tpc} was designed which can be reused for future prototyping efforts.
The design of PCB and \gls{tpc} as well as the results from the first tests are described in Section~\ref{sec:ac_viper}.