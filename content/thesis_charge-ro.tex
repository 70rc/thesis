...
\subsection{Charge Readout Summary}
\label{sec:studies_charge-ro_summary}
...
Due to the lack of bespoke pixel electronics able to readout so many channels (see Section~\ref{sec:studies_electronics_pixel}), a form of analogue multiplexing had to be employed.
