...
\subsection*{A More Robust Approach to TPC Readout Wires}
...
More details can be found in Section~\ref{sec:studies_electronics}.
...
A detailed description of upcoming electronics capable of cold digitisation an multiplexing is given in Section~\ref{sec:studies_electronics}.
...
The design of PCB and TPC as well as the results from the first tests are described in Section~\ref{sec:ac_viper}.
