...
Besides their mechanical fragility, they cripple the excellent 3D tracking capabilities of a \gls{ac:tpc} by reducing it two multiple 2D projections.
...
A new prototype \gls{ac:tpc} was designed and built to test the pixelated charge readout scheme.
...
High cathode voltages are prevented by splitting the detector into several small, self-contained \glspl{ac:tpc} requiring only a moderate \SI{50}{\kilo\volt} cathode voltage.
