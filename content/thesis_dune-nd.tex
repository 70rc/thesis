...
\begin{figure}[tbp]
	\centering
	\includegraphics[width=\textwidth]{ac/dune_nd/Assembly_ND-1}
	\caption[\AC{} \glsentryshort{dune} \glsentryshort{nd} engineering drawing]{%
		Preliminary engineering drawing of \AC{} in the \acrshort{dune} \acrshort{nd}.
		\num{4 x 5} modules with the longer dimension in beam direction.
		Service volumes make up the remainder of the \SI{5 x 5}{\metre} \acrshort{lar} bath contained within a low-radiation-length foam-insulated membrane cryostat.
	}
...
Inspired by the design of the \dune{} \SI{35}{\tonne} prototype at \gls{fail}~\cite{dune4} the \lar{} bath is contained within a foam-insulated membrane cryostat.
