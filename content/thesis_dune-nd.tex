...
The TPC will be mounted inside an otherwise empty module, hanging from an intermediate support layer.
...
\begin{table}[htb]
	...
	\begin{tabu} to \textwidth {lSSs}
		...
		TPC height &					1.235 &					3.000 &					\metre \\
		Total TPC volume &				2.218 &					60.000 &				\metre\cubed \\
