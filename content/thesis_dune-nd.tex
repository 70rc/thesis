...
\begin{figure}[htb]
	...
	\caption[\AC{} \num{2 x 2} prototype module engineering drawing]{%
		Engineering drawings of a \SI{0.67 x 0.67 x 1.81}{\metre} module with hanging pixel demonstrator \acrshort{tpc} for the \AC{} \num{2 x 2} module \AC{} prototype at \acrshort{help}.
	}
	\label{fig:2x2_mod}
\end{figure}
...
After a successful test of all subsystems, it is planned to be installed in a charged particle test beam at either CERN or \gls{fail} to investigate the influence of the module walls on calorimetry and tracking.\todo{Is this still valid?}
...
In addition, power dissipation would increase proportionally to the event rate due to the smart zero suppression scheme of \larpix{}.
