...
According to the simulations, \SI{2.5}{\metre} would be sufficient but provide not safety margin at all.
...
Many events are simply not contained because of their specific location inside the detector.
...
Inspired by the design of the \dune{} \SI{35}{tonne} prototype at Fermilab~\cite{dune4}, the \lar{} bath is held in a foam-insulated membrane cryostat.
