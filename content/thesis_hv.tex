\chapter{Experimental Studies on High Voltage, Charge Readout, and Light Collection}
\label{chap:studies}
...
\subsection*{A Method to Suppress Electric Breakdowns in Liquid Argon}
...
The setup was the same as the one used to study the breakdowns, described above.
