\chapter{The \acrfull{ac:lartpc}}
\label{chap:lartpc}

The \gls{ac:tpc} is a derivative of Charpak's Multi-Wire Proportional Chamber (MWPC)\cite{mwpc} developed by Nygren in the late 1970s~\cite{nygrenTPC}.
...
While gaseous \glspl{ac:tpc} already provide very accurate tracking, they have the disadvantage that the target mass and thus, the cross-section of the detection medium is quite low resulting in a low interaction rate.
...
\section{\acrfull{ac:lar} as a Detection Medium}
\label{sec:lartpc_lar}

For an efficient particle detection by a \gls{ac:tpc}, several properties of the sensitive medium are of interest, such as ionisation and light yield, electron-ion pair recombination, dielectric strength, length scales of electromagnetic and hadronic interactions, density, transparency to its own scintillation light, and the boiling point.
...
In order to register the ionisations tracks of charged particles in a \gls{ac:tpc}, two processes are crucial: production and transportation of charge.
...
This is one of the reasons why (liquefied) noble gases are a prime choice for \glspl{ac:tpc}.
...
Classically, the charge readout of a liquid argon \gls{ac:tpc} is done using wires with a diameter of $\order{\SI{.1}{\milli\metre}}$.
