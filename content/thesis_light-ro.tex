...
\begin{figure}[htb]
	...
	\caption{\SI{10 x 10}{\centi\metre} \AL{} prototype.
		Four \glspl{sipm} can be seen at the lower side, soldered to a narrow PCB providing coaxial connectors for signal readout.
...
The ratio of sensitive area to total area is \SI{98}{\percent} with the remaining \SI{2}{\percent} occupied by a PCB carrying four \emph{Hamamatsu S13360-3050VE}\footnote{\url{http://www.hamamatsu.com}} \glspl{sipm} with a sensitive area of \SI{3 x 3}{\milli\metre} each.
...
\begin{figure}[htb]
	...
	\caption{\AL{} light collector cross-section near a corner.
		...
		At the bottom of the left picture, two of the four \glspl{sipm} mounted to the carrier PCB are visible.}
