...
\begin{figure}[htbp]
	...
	\caption[\pixlar{} \glsentryshort{arclight} response stability]{%
		...
		For reference, the primary beam energy (black) and the bending magnet current (red) are shown.
	}
...
For reference, the current of the bending magnets, selecting the momentum range of the tertiary beam, and the primary beam energy are also plotted.
