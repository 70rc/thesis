...
\begin{figure}[htb]
	...
	\caption{\AL{} light collector cross-section near a corner.
		...
		The outer surface of the dichroic mirror is coated with \gls{tpb} to shift the \lar{} \gls{vuv} scintillation light to the blue range where the dichroic film is transparent.
...
\begin{figure}[htb]
	...
	\caption{Measured \gls{pde} for the \SI{10 x 10}{\centi\metre} \AL{} prototype (in the background), at room temperature.
		The \gls{pde} is given in \si{\percent}.
		Near the \glspl{sipm} at the bottom, the \gls{pde} is increased due to an increased fraction of direct photons, avoiding the initial loss at the first reflection from the dichroic mirror.}
