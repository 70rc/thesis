...
Furthermore, the rising edge of the \gls{hv} pulse needs to be extremely short ($\order{\SI{1}{\nano\second}}$).
...
The aforementioned \si{\mega\watt} beam intensity leads to \gls{nd} event rates $\order{0.1}$ events per tonne of \lar{} leading to significant event pile-up (see Table~\ref{tab:nu-detection_beam-params}).
