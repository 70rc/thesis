...
Furthermore, both are plane wave functions which is also wrong.
...
Figure~\ref{fig:nu-detection_xsec_flux} depicts the cross-section (see next paragraph) of neutrino interactions as a function of neutrino energy.
