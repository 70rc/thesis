...
In particular, Daya Bay and \gls{t2k} measured a non-zero for the $\theta_{13}$ mixing angle which enables a potential discovery of \gls{cp} violation in the lepton sector via neutrino oscillation in matter (see Section~\ref{sec:nu-detection_osc}).
...
\begin{figure}[htb]
	...
	\caption[\glsentryshort{dune}]{%
		\acrshort{dune}, a next-generation long-baseline neutrino oscillation experiment consisting of a neutrino beamline and \acrshort{nd} complex at \acrshort{fail}, and \acrshort{lartpc} \glspl{fd} at \acrshort{surf}.~\cite{dune1}
	}
