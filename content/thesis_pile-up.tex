...
In summary, this study shows that even a very primitive \gls{em} shower reconstruction algorithm, employing a cone-cylinder union selection, performs well in the high-multiplicity environment of the \dune{} \gls{nd}, when fed with unambiguous 3D spatial coordinates of energy depositions.
