...
The spatial resolution of the pixel readout is assumed to be \SI{0.3}{\centi\metre} based on the ND design specified in Section~\ref{sec:dune-nd_ac_nd}\todo{justify!}.
...
Active volume dimensions are taken from the preliminary \dune{} near detector design described in Section~\ref{sec:dune-nd_ac_nd}.
