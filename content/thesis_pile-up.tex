...
The spatial resolution of the pixel readout is assumed to be \SI{0.3}{\centi\metre} in both directions based on the \gls{nd} design specified in Section~\ref{sec:dune-nd_ac_nd}\todo{justify!}.
...
Table~\ref{tab:dune-nd_pile-up-params} contains a summary of all the \lar{} volume dimensions, Figure~\ref{fig:dune-nd_example-display} shows and example event with all three volumes drawn.
