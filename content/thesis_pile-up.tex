...
From Figure~\ref{fig:dune-nd_2MW_misid-rel-x}, this can be determined to be about \SIrange{2}{3}{\percent} at the flux peak ($\approx \SI{2.5}{\giga\electronvolt}$, see Figure~\ref{fig:nu-detection_dune-flux}).
