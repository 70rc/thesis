...
\begin{figure}[htb]
	...
	On the left, the pinheader connected to the bias \gls{hv} power suplly is shown. In the middle and on the right are the connections to the pixels and inductive ROI grids.
