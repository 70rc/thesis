...
\begin{frame}{Unknown Parameters}{How to measure them}
	\begin{IEEEeqnarray*}{rCl}
		P \qty(\Pgngm \rightarrow \Pgne) &	= &	\sin[2](\theta_{23}) \sin[2](2 \theta_{13}) \sin[2](\Delta) \\
...
\begin{frame}{Step-by-step 3D event reconstruction}
	\begin{columns}[c]
		...
		\column{.5\textwidth}
		\centering
		\only<1>{\includegraphics[height=.4\textheight]{viper/event967_rawUnfilteredROI}\\\includegraphics[height=.4\textheight]{viper/event967_rawFilteredROI}\\{\tiny Asaadi, Goeldi et al.; arXiv:~1801.08884~\cite{pixel_paper}}}
		\only<2>{\includegraphics[page=1, height=.4\textheight]{viper/event967_pixel2_hit8}\\\includegraphics[page=3, height=.4\textheight]{viper/event967_pixel2_hit8}\\{\tiny Asaadi, Goeldi et al.; arXiv:~1801.08884~\cite{pixel_paper}}}
		\only<3>{\includegraphics[height=.8\textheight]{viper/event967_pulses_a_pca}\\{\tiny Asaadi, Goeldi et al.; arXiv:~1801.08884~\cite{pixel_paper}}}
		\only<4>{\includegraphics[width=.8\textheight, angle=-90]{defence/event967_kalman}\\{\tiny Asaadi, Goeldi et al.; arXiv:~1801.08884~\cite{pixel_paper}}}
	\end{columns}
\end{frame}
