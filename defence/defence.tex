...
\title[\Subtitle]{\Title}
\subtitle{\texorpdfstring{\includegraphics[height=3cm]{defence/ArgonCube-Logo}}{\Subtitle}}
\author{\Author}
\institute[Uni Bern]{Albert Einstein Centre, Laboratory for High Energy Physics, University of Bern}
\date[\Date]{\Date}
\logo{\includegraphics[height=1cm]{defence/Logo_AEC}}
