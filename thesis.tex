...
\begin{document}
	...
	\include{content/thesis_title}
	\include{content/thesis_abstract}
	\include{content/thesis_preface}
	...
	\include{content/thesis_introduction}
	\include{content/thesis_nu-detection}
	\include{content/thesis_lartpc}
	\include{content/thesis_hv}
	\include{content/thesis_charge-ro}
	\include{content/thesis_electronics}
	\include{content/thesis_light-ro}
	\include{content/thesis_viper}
	\include{content/thesis_argoncube}
	\include{content/thesis_dune-nd}
	\include{content/thesis_pile-up}
	\include{content/thesis_conclusion}
	\include{content/thesis_acknowledgements}
	
	\printbibliography
	
	\appendix
	
	\include{content/thesis_appendix_pile-up-data}
